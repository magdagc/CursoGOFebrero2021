...
3. En la collection de postman **api_rest.postman_collection.json** está el mismo request en **01_cliente_http/GET_gopherize_me** por si queremos probarlo allí.  
